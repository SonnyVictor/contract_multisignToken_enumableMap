...
contract LockAngelInvestment is Ownable {
    IERC20 public  token;
    DateTime private dateTimeContract;

    uint256 public constant totalAmount = 20_000_000 * 10 ** 18;
    uint256 public constant UnLockEachMonth = 2_000_000 * 10 ** 18;
